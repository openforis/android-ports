 ...
 */
package org.arbonaut.jp.spi;

import java.util.Map;

import org.arbonaut.jp.EntityManagerFactory;
/**
 * Interface implemented by a persistence provider.
 * The implementation of this interface that is to
 * be used for a given {@link org.arbonaut.jp.EntityManager} is specified in
 * persistence.xml file in the persistence archive.
 * This interface is invoked by the Container when it
 * needs to create an {@link org.arbonaut.jp.EntityManagerFactory}, or by the
...
public interface PersistenceProvider {
    ...
    /**
    * Called by Persistence class when an {@link org.arbonaut.jp.EntityManagerFactory}
    * is to be created.
    *
    ...
    */
    ...
    /**
     * Called by the container when an {@link org.arbonaut.jp.EntityManagerFactory}
     * is to be created.
     *
